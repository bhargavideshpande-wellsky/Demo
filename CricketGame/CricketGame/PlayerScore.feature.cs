...
#line 13
 testRunner.When("Player score 4 runs", ((string)(null)), ((TechTalk.SpecFlow.Table)(null)), "When ");
#line 14
...
#line 19
 testRunner.When("Player score 3 runs", ((string)(null)), ((TechTalk.SpecFlow.Table)(null)), "When ");
#line 20
...
#line hidden
        ...
        [Xunit.FactAttribute(DisplayName="Player should not be able score runs after getting out")]
        [Xunit.TraitAttribute("FeatureTitle", "PlayerScore")]
        [Xunit.TraitAttribute("Description", "Player should not be able score runs after getting out")]
        public virtual void PlayerShouldNotBeAbleScoreRunsAfterGettingOut()
        {
            TechTalk.SpecFlow.ScenarioInfo scenarioInfo = new TechTalk.SpecFlow.ScenarioInfo("Player should not be able score runs after getting out", ((string[])(null)));
#line 22
this.ScenarioSetup(scenarioInfo);
#line 23
 testRunner.Given("Player has started a game of cricket", ((string)(null)), ((TechTalk.SpecFlow.Table)(null)), "Given ");
